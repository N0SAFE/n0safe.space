      ...
      <div class="flex flex-wrap justify-between items-center">
        ...
        <div class="flex items-center lg:order-2">
          ...
          <button
            ...
            "
            @click="toggleDropdown(dropdown.notification)"
          >
          ...
          <div
            class="
              ...
              absolute
            "
            ref="notificationDropdownElement"
            id="notification-dropdown"
            :style="{
              inset: ' 0px auto auto 0px',
              margin: '0px',
              transform: `translate(${notificationDropdownTranslate.x}px, ${notificationDropdownTranslate.y}px)`,
            }"
          >
            <div
              class="
          ...
          <button
            ...
            class="
              ...
              dark:focus:ring-gray-600
            "
            @click="toggleDropdown(dropdown.apps)"
          >
            <span class="sr-only">View notifications</span>
            <!-- Icon -->
            <svg
          ...
          <div
            class="
              ...
              absolute
            "
            ref="appsDropdownElement"
            id="apps-dropdown"
            :style="{
              inset: ' 0px auto auto 0px',
              margin: '0px',
              transform: `translate(${appsDropdownTranslate.x}px, ${appsDropdownTranslate.y}px)`,
            }"
          >
            <div
              class="
          ...
          <button
            ...
            id="user-menu-button"
            aria-expanded="false"
            @click="toggleDropdown(dropdown.user)"
          >
          ...
          <div
            ...
            :style="{
              inset: ' 0px auto auto 0px',
              margin: '0px',
              transform: `translate(${userDropdownTranslate.x}px, ${userDropdownTranslate.y}px)`,
            }"
          >
            <div class="py-3 px-4">
              <span
...
const navbarsize = useElementSize(navbarElement)

const userDropdownElement = ref()
const userDropdownSize = useElementSize(userDropdownElement)
const userDropdownTranslate = computed(() => {
  return {
    x: navbarsize.width.value - userDropdownSize.width.value,
    y: navbarsize.height.value,
  }
})

const appsDropdownElement = ref()
const appsDropdownSize = useElementSize(appsDropdownElement)
const appsDropdownTranslate = computed(() => {
  return {
    x: navbarsize.width.value - appsDropdownSize.width.value,
    y: navbarsize.height.value,
  }
})

const notificationDropdownElement = ref()
const notificationDropdownSize = useElementSize(notificationDropdownElement)
const notificationDropdownTranslate = computed(() => {
  return {
    x: navbarsize.width.value - notificationDropdownSize.width.value,
    y: navbarsize.height.value,
  }
})
...
function toggleDropdown(selectedDropdown) {
  switch (selectedDropdown) {
    case dropdown.user:
      userDropdownElement.value.classList.toggle('hidden')
      appsDropdownElement.value.classList.add('hidden')
      notificationDropdownElement.value.classList.add('hidden')
      break
    case dropdown.apps:
      appsDropdownElement.value.classList.toggle('hidden')
      userDropdownElement.value.classList.add('hidden')
      notificationDropdownElement.value.classList.add('hidden')
      break
    case dropdown.notification:
      notificationDropdownElement.value.classList.toggle('hidden')
      userDropdownElement.value.classList.add('hidden')
      appsDropdownElement.value.classList.add('hidden')
      break
  }
