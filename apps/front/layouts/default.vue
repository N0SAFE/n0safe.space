<template>
    <div :class="isDark && 'dark'" class="bg-gray-50 dark:bg-gray-900 transition-colors duration-300 ease-in-out min-h-screen flex text-gray-900 dark:text-white
    ">
    ...
    <button @click="toggleDark" class="fixed bottom-0 right-0 p-4 m-4 rounded-full bg-gray-50 dark:bg-gray-900">
        <svg v-if="isDark" class="w-6 h-6 text-gray-900 dark:text-white" fill="currentColor" viewBox="0 0 24 24">
            <path
                fill-rule="evenodd"
                clip-rule="evenodd"
        ...
        <svg v-else class="w-6 h-6 text-gray-900 dark:text-white" fill="currentColor" viewBox="0 0 24 24">
            <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M12 0C5.373 0 0 5.373 0 12C0 18.627 5.373 24 12 24C18.627 24 24 18.627 24 12C24 5.373 18.627 0 12 0ZM12 22.5C6.201 22.5 1.5 17.799 1.5 12C1.5 6.201 6.201 1.5 12 1.5C17.799 1.5 22.5 6.201 22.5 12C22.5 17.799 17.799 22.5 12 22.5Z"
